...
export const metadata: Metadata = {
  title: "Recambios Sachs — Marketplace B2B | Recambio Directo",
  description: "Amortiguadores y embragues Sachs para talleres. Precios B2B con entrega rápida en toda España.",
  alternates: { canonical: "https://www.recambio-directo.com/marcas/sachs" },
};

const jsonLd = "{\"@context\": \"https://schema.org\", \"@type\": \"CollectionPage\", \"name\": \"Recambios Sachs\", \"description\": \"Amortiguadores y embragues Sachs para talleres. Precios B2B con entrega r\u00e1pida en toda Espa\u00f1a.\", \"url\": \"https://www.recambio-directo.com/marcas/sachs\", \"isPartOf\": {\"@type\": \"WebSite\", \"name\": \"Recambio Directo\", \"url\": \"https://www.recambio-directo.com\"}, \"breadcrumb\": {\"@type\": \"BreadcrumbList\", \"itemListElement\": [{\"@type\": \"ListItem\", \"position\": 1, \"name\": \"Inicio\", \"item\": \"https://www.recambio-directo.com\"}, {\"@type\": \"ListItem\", \"position\": 2, \"name\": \"Recambios Sachs\", \"item\": \"https://www.recambio-directo.com/marcas/sachs\"}]}}";
      ...
      <main style={{ minHeight: "100vh", background: "linear-gradient(135deg,#020617,#020b2d)", color: "white", padding: "60px 20px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <nav style={{ marginBottom: 32, fontSize: 13, color: "#64748b" }}>
            ...
            {" › "}
            <span style={{ color: "#94a3b8" }}>Recambios Sachs</span>
          </nav>
          ...
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            ...
            <p style={{ color: "#94a3b8", fontSize: 18, maxWidth: 650, margin: "0 auto", lineHeight: 1.7 }}>
              Sachs, marca de ZF Aftermarket, es proveedor original de amortiguadores y embragues para BMW, Audi, Mercedes y Porsche. Con más de 125 años de experiencia, sus productos combinan confort de conducción y durabilidad extrema.
            </p>
          </div>
          ...
          <div style={{ background: "rgba(15,23,42,0.92)", borderRadius: 24, padding: 32, border: "1px solid rgba(255,255,255,0.06)", marginBottom: 24 }}>
            <h2 style={{ fontSize: 24, fontWeight: 900, marginBottom: 16 }}>Productos Sachs disponibles</h2>
            <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <li key={"Copelas"} style={{ display: "flex", gap: 10, alignItems: "center" }}>
                <span style={{ color: "#22c55e", fontWeight: 900, fontSize: 18 }}>✓</span>
                <span style={{ color: "#cbd5e1", fontSize: 15 }}>Copelas</span>
              </li>
            </ul>
          </div>
          ...
          <div style={{ background: "rgba(15,23,42,0.92)", borderRadius: 24, padding: 32, border: "1px solid rgba(255,255,255,0.06)", marginBottom: 24 }}>
            ...
            <p style={{ color: "#94a3b8", fontSize: 15, lineHeight: 1.8 }}>
              Especialidad en vehículos alemanes: BMW, Audi, VW, Mercedes, Porsche. También Ford, Opel y SEAT.
            </p>
          </div>

          <div style={{ background: "rgba(15,23,42,0.92)", borderRadius: 24, padding: 32, border: "1px solid rgba(255,255,255,0.06)", marginBottom: 24 }}>
            <h2 style={{ fontSize: 24, fontWeight: 900, marginBottom: 16 }}>¿Por qué elegir Sachs?</h2>
            <p style={{ color: "#94a3b8", fontSize: 15, lineHeight: 1.8 }}>
              Sachs es la elección segura para amortiguadores y embragues de gama premium. Siendo OE de la mayoría de alemanes, evitas problemas de compatibilidad.
            </p>
          </div>

          <div style={{ textAlign: "center", marginTop: 48 }}>
            <h2 style={{ fontSize: 28, fontWeight: 900, marginBottom: 16 }}>Compara precios de Sachs</h2>
            <p style={{ color: "#94a3b8", marginBottom: 24, fontSize: 16 }}>Accede a proveedores verificados con stock de Sachs. Primer mes gratis.</p>
