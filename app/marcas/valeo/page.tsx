...
export const metadata: Metadata = {
  title: "Recambios Valeo — Marketplace B2B | Recambio Directo",
  description: "Recambios Valeo: embragues, alternadores, motores de arranque y climatización. Precios B2B para talleres.",
  alternates: { canonical: "https://www.recambio-directo.com/marcas/valeo" },
};

const jsonLd = "{\"@context\": \"https://schema.org\", \"@type\": \"CollectionPage\", \"name\": \"Recambios Valeo\", \"description\": \"Recambios Valeo: embragues, alternadores, motores de arranque y climatizaci\u00f3n. Precios B2B para talleres.\", \"url\": \"https://www.recambio-directo.com/marcas/valeo\", \"isPartOf\": {\"@type\": \"WebSite\", \"name\": \"Recambio Directo\", \"url\": \"https://www.recambio-directo.com\"}, \"breadcrumb\": {\"@type\": \"BreadcrumbList\", \"itemListElement\": [{\"@type\": \"ListItem\", \"position\": 1, \"name\": \"Inicio\", \"item\": \"https://www.recambio-directo.com\"}, {\"@type\": \"ListItem\", \"position\": 2, \"name\": \"Recambios Valeo\", \"item\": \"https://www.recambio-directo.com/marcas/valeo\"}]}}";
      ...
      <main style={{ minHeight: "100vh", background: "linear-gradient(135deg,#020617,#020b2d)", color: "white", padding: "60px 20px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <nav style={{ marginBottom: 32, fontSize: 13, color: "#64748b" }}>
            ...
            {" › "}
            <span style={{ color: "#94a3b8" }}>Recambios Valeo</span>
          </nav>
          ...
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            ...
            <p style={{ color: "#94a3b8", fontSize: 18, maxWidth: 650, margin: "0 auto", lineHeight: 1.7 }}>
              Valeo es un gigante francés de la automoción con presencia en 33 países. Proveedor OE de Renault, PSA, Stellantis y Toyota, su catálogo aftermarket abarca embragues, sistemas eléctricos, térmicos y de visibilidad.
            </p>
          </div>
          ...
          <div style={{ background: "rgba(15,23,42,0.92)", borderRadius: 24, padding: 32, border: "1px solid rgba(255,255,255,0.06)", marginBottom: 24 }}>
            <h2 style={{ fontSize: 24, fontWeight: 900, marginBottom: 16 }}>Productos Valeo disponibles</h2>
          ...
          <div style={{ background: "rgba(15,23,42,0.92)", borderRadius: 24, padding: 32, border: "1px solid rgba(255,255,255,0.06)", marginBottom: 24 }}>
            ...
            <p style={{ color: "#94a3b8", fontSize: 15, lineHeight: 1.8 }}>
              Especialista en marcas francesas (Renault, Peugeot, Citroën, DS) y japonesas (Toyota, Nissan).
            </p>
          </div>

          <div style={{ background: "rgba(15,23,42,0.92)", borderRadius: 24, padding: 32, border: "1px solid rgba(255,255,255,0.06)", marginBottom: 24 }}>
            <h2 style={{ fontSize: 24, fontWeight: 900, marginBottom: 16 }}>¿Por qué elegir Valeo?</h2>
            <p style={{ color: "#94a3b8", fontSize: 15, lineHeight: 1.8 }}>
              Valeo ofrece la mejor relación calidad-precio en embragues para vehículos franceses. Su kit 4P incluye volante bimasa, disco, plato y rodamiento.
            </p>
          </div>

          <div style={{ textAlign: "center", marginTop: 48 }}>
            <h2 style={{ fontSize: 28, fontWeight: 900, marginBottom: 16 }}>Compara precios de Valeo</h2>
            <p style={{ color: "#94a3b8", marginBottom: 24, fontSize: 16 }}>Accede a proveedores verificados con stock de Valeo. Primer mes gratis.</p>
