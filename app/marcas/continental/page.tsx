...
export const metadata: Metadata = {
  title: "Recambios Continental — Marketplace B2B | Recambio Directo",
  description: "Kits de distribución y correas Continental para talleres. Precios B2B con entrega rápida.",
  alternates: { canonical: "https://www.recambio-directo.com/marcas/continental" },
};

const jsonLd = "{\"@context\": \"https://schema.org\", \"@type\": \"CollectionPage\", \"name\": \"Recambios Continental\", \"description\": \"Kits de distribuci\u00f3n y correas Continental para talleres. Precios B2B con entrega r\u00e1pida.\", \"url\": \"https://www.recambio-directo.com/marcas/continental\", \"isPartOf\": {\"@type\": \"WebSite\", \"name\": \"Recambio Directo\", \"url\": \"https://www.recambio-directo.com\"}, \"breadcrumb\": {\"@type\": \"BreadcrumbList\", \"itemListElement\": [{\"@type\": \"ListItem\", \"position\": 1, \"name\": \"Inicio\", \"item\": \"https://www.recambio-directo.com\"}, {\"@type\": \"ListItem\", \"position\": 2, \"name\": \"Recambios Continental\", \"item\": \"https://www.recambio-directo.com/marcas/continental\"}]}}";
      ...
      <main style={{ minHeight: "100vh", background: "linear-gradient(135deg,#020617,#020b2d)", color: "white", padding: "60px 20px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <nav style={{ marginBottom: 32, fontSize: 13, color: "#64748b" }}>
            ...
            {" › "}
            <span style={{ color: "#94a3b8" }}>Recambios Continental</span>
          </nav>
          ...
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            ...
            <h1 style={{ fontSize: "clamp(36px, 5vw, 56px)", fontWeight: 900, marginBottom: 16, lineHeight: 1.1 }}>
              Recambios Continental
            </h1>
            <p style={{ color: "#94a3b8", fontSize: 18, maxWidth: 650, margin: "0 auto", lineHeight: 1.7 }}>
              Continental AG, además de ser un gigante del neumático, es uno de los mayores fabricantes de correas y kits de distribución. Su marca ContiTech equipa de serie a VW, Audi, BMW, Mercedes, Ford y muchos más.
            </p>
          </div>
          ...
          <div style={{ background: "rgba(15,23,42,0.92)", borderRadius: 24, padding: 32, border: "1px solid rgba(255,255,255,0.06)", marginBottom: 24 }}>
            <h2 style={{ fontSize: 24, fontWeight: 900, marginBottom: 16 }}>Productos Continental disponibles</h2>
          ...
          <div style={{ background: "rgba(15,23,42,0.92)", borderRadius: 24, padding: 32, border: "1px solid rgba(255,255,255,0.06)", marginBottom: 24 }}>
            ...
            <p style={{ color: "#94a3b8", fontSize: 15, lineHeight: 1.8 }}>
              Cobertura universal para turismos europeos y asiáticos. Especialidad en VAG, BMW y Ford.
            </p>
          </div>

          <div style={{ background: "rgba(15,23,42,0.92)", borderRadius: 24, padding: 32, border: "1px solid rgba(255,255,255,0.06)", marginBottom: 24 }}>
            <h2 style={{ fontSize: 24, fontWeight: 900, marginBottom: 16 }}>¿Por qué elegir Continental?</h2>
            <p style={{ color: "#94a3b8", fontSize: 15, lineHeight: 1.8 }}>
              Continental fabrica las correas que van de serie. Usar Continental en la distribución es usar la pieza original: máxima seguridad ante una operación donde un fallo destruye el motor.
            </p>
          </div>

          <div style={{ textAlign: "center", marginTop: 48 }}>
            <h2 style={{ fontSize: 28, fontWeight: 900, marginBottom: 16 }}>Compara precios de Continental</h2>
            <p style={{ color: "#94a3b8", marginBottom: 24, fontSize: 16 }}>Accede a proveedores verificados con stock de Continental. Primer mes gratis.</p>
