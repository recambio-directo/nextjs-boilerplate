...
export const metadata: Metadata = {
  title: "Recambios NGK — Marketplace B2B | Recambio Directo",
  description: "Bujías y sondas lambda NGK para talleres. Precios B2B con entrega en 24h en Recambio Directo.",
  alternates: { canonical: "https://www.recambio-directo.com/marcas/ngk" },
};

const jsonLd = "{\"@context\": \"https://schema.org\", \"@type\": \"CollectionPage\", \"name\": \"Recambios NGK\", \"description\": \"Buj\u00edas y sondas lambda NGK para talleres. Precios B2B con entrega en 24h en Recambio Directo.\", \"url\": \"https://www.recambio-directo.com/marcas/ngk\", \"isPartOf\": {\"@type\": \"WebSite\", \"name\": \"Recambio Directo\", \"url\": \"https://www.recambio-directo.com\"}, \"breadcrumb\": {\"@type\": \"BreadcrumbList\", \"itemListElement\": [{\"@type\": \"ListItem\", \"position\": 1, \"name\": \"Inicio\", \"item\": \"https://www.recambio-directo.com\"}, {\"@type\": \"ListItem\", \"position\": 2, \"name\": \"Recambios NGK\", \"item\": \"https://www.recambio-directo.com/marcas/ngk\"}]}}";
      ...
      <main style={{ minHeight: "100vh", background: "linear-gradient(135deg,#020617,#020b2d)", color: "white", padding: "60px 20px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <nav style={{ marginBottom: 32, fontSize: 13, color: "#64748b" }}>
            ...
            {" › "}
            <span style={{ color: "#94a3b8" }}>Recambios NGK</span>
          </nav>
          ...
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            ...
            <p style={{ color: "#94a3b8", fontSize: 18, maxWidth: 650, margin: "0 auto", lineHeight: 1.7 }}>
              NGK Spark Plug Co. es el líder mundial en tecnología de encendido. Proveedor OE de Toyota, Honda, Nissan, Subaru, BMW y Mercedes, sus bujías de iridio y platino ofrecen el máximo rendimiento y durabilidad.
            </p>
          </div>
          ...
          <div style={{ background: "rgba(15,23,42,0.92)", borderRadius: 24, padding: 32, border: "1px solid rgba(255,255,255,0.06)", marginBottom: 24 }}>
            <h2 style={{ fontSize: 24, fontWeight: 900, marginBottom: 16 }}>Productos NGK disponibles</h2>
            <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: 10 }}>
              <li key={"Bujías de encendido"} style={{ display: "flex", gap: 10, alignItems: "center" }}>
                <span style={{ color: "#22c55e", fontWeight: 900, fontSize: 18 }}>✓</span>
                <span style={{ color: "#cbd5e1", fontSize: 15 }}>Bujías de encendido</span>
              </li>
          ...
          <div style={{ background: "rgba(15,23,42,0.92)", borderRadius: 24, padding: 32, border: "1px solid rgba(255,255,255,0.06)", marginBottom: 24 }}>
            ...
            <p style={{ color: "#94a3b8", fontSize: 15, lineHeight: 1.8 }}>
              Cobertura universal: especialmente marcas japonesas (Toyota, Honda, Nissan, Mazda) y alemanas (BMW, VW/Audi).
            </p>
          </div>

          <div style={{ background: "rgba(15,23,42,0.92)", borderRadius: 24, padding: 32, border: "1px solid rgba(255,255,255,0.06)", marginBottom: 24 }}>
            <h2 style={{ fontSize: 24, fontWeight: 900, marginBottom: 16 }}>¿Por qué elegir NGK?</h2>
            <p style={{ color: "#94a3b8", fontSize: 15, lineHeight: 1.8 }}>
              NGK es la referencia en bujías: equipa de serie más vehículos que cualquier otro fabricante. Sus bujías de iridio duran hasta 120.000 km.
            </p>
          </div>

          <div style={{ textAlign: "center", marginTop: 48 }}>
            <h2 style={{ fontSize: 28, fontWeight: 900, marginBottom: 16 }}>Compara precios de NGK</h2>
            <p style={{ color: "#94a3b8", marginBottom: 24, fontSize: 16 }}>Accede a proveedores verificados con stock de NGK. Primer mes gratis.</p>
