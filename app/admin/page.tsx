...
==========================================`;
        ...
        {seccion === "pedidos" && (
          <div>
            ...
            <div style={tableContainer}>
              <table style={tableStyle}>
                <thead><tr>{["CÓDIGO", "CLIENTE", "TOTAL", "ESTADO", "FECHA", "ANULADO", "ACCIÓN"].map(h => <th key={h} style={thStyle}>{h}</th>)}</tr></thead>
                <tbody>
                  {pedidos.map(p => (
