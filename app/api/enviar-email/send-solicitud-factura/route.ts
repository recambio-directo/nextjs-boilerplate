          ...
          <div style="background:white;padding:32px;border-radius:12px;max-width:600px;margin:auto;">
            ...
            <div style="background:#fef3c7;border-left:4px solid #f59e0b;padding:14px 18px;margin-bottom:20px;">
              <p style="margin:0;color:#92400e;font-size:13px;">
                ⚠️ <strong>Acción requerida:</strong> Sube la factura PDF en el panel de pedidos de Recambio Directo 
                para que el cliente pueda descargarla.
              </p>
            </div>

            <hr style="margin:24px 0;border:none;border-top:1px solid #e5e7eb;" />
            <p style="color:#9ca3af;font-size:12px;text-align:center;margin:0;">
              Recambio Directo — Marketplace B2B de recambios de automoción
            </p>
          </div>
        </div>
      `,
        ...
        <div style="font-family:Arial;padding:30px;background:#f3f4f6;">
          <div style="background:white;padding:32px;border-radius:12px;max-width:600px;margin:auto;">
            ...
            <p style="color:#374151;font-size:15px;line-height:1.7;margin-bottom:20px;">
              Hemos enviado tu solicitud de factura a <strong>${proveedorNombre}</strong> 
              para el pedido <strong>${pedidoCodigo}</strong>.
            </p>
            ...
            <p style="color:#6b7280;font-size:13px;">
              Una vez el proveedor suba la factura, aparecerá disponible para descargar 
              en tu panel de pedidos en Recambio Directo.
            </p>
            <hr style="margin:24px 0;border:none;border-top:1px solid #e5e7eb;" />
            <p style="color:#9ca3af;font-size:12px;text-align:center;margin:0;">
              Recambio Directo — Marketplace B2B de recambios de automoción
